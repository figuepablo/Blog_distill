...
write.xlsx(files_df,"Files/item_list.xlsx",row.names = F)



precios <- read.xlsx("Files/Precios.xlsx",sheetName = "Sheet1")

prices_df <- files_df %>% left_join(precios) %>% arrange(item_name)
